...
\begin{abstract}
False information poses a challenge in Internet of Vehicles which is by nature collaborative. For this reason several mechanisms have been proposed for detection of false information and for trust management in SIoV, most of which employ reputation as an important factor. In this paper we propose a simple reputation mechanism for IoV that uses false information detection mechanisms to generate and share feedback and uses this feedback to generate a reputation score that may be used as a factor in a trust management system or a false message detection system. The reputation system has been shown experimentally to have high accuracy in detection of nodes sending false information and is robust in the presence of false feedback being generated. 
\end{abstract}
