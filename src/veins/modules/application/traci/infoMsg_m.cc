...
void infoMsg::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->correct);
}
...
void infoMsg::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->correct);
}
...
int infoMsg::getMsgId() const
{
    return this->msgId;
}

void infoMsg::setMsgId(int msgId)
{
    this->msgId = msgId;
}

bool infoMsg::getCorrect() const
{
    return this->correct;
}

void infoMsg::setCorrect(bool correct)
{
...
std::string infoMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return bool2string(pp->getCorrect());
        default: return "";
    }
}
...
bool infoMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setCorrect(string2bool(value)); return true;
